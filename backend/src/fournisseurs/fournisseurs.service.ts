...
export class FournisseursService {
  ...
  async create(clientId: number, dto: CreateFournisseurDto, currentUser: User) {
  ...
  async update(id: number, clientId: number, dto: Partial<CreateFournisseurDto>, currentUser: User) {
    await this.clientsService.assertCanEdit(clientId, currentUser);
